...
You will need the **Titanfall Map Exporter** python script and the **Titanfall VPK Tool** from the [Modding Tools](../start-modding/modding-intro/tools/) page. If you don't have python installed, you will also need that.
