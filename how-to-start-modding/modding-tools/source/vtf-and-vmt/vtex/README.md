...
Valve Texture Tool, or Vtex  is the [command-line](https://developer.valvesoftware.com/wiki/Command-line) tool used to convert [targa \(.tga\)](../../../../../information/file-format/truevision-graphics-adapter-tga.md) or [Photoshop \(.psd\)](../../../../../information/file-format/psd-photoshop-document.md) \(Orange box SDK\) image files into [Valve Texture Files \(.vtf\)](../../../../../information/textures/valve-texture-format-vtf/) for use in the Source engine. It takes a [targa \(.tga\)](../../../../../information/file-format/truevision-graphics-adapter-tga.md) image and an optional list of compile parameters, and creates a [Valve Texture File \(.vtf\)](../../../../../information/textures/valve-texture-format-vtf/) from them.
